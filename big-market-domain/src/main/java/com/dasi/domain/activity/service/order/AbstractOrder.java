...
public abstract class AbstractOrder implements IOrder {
    ...
    public String createSkuRechargeOrder(SkuRecharge skuRecharge) {
        ...
        // 3. 活动规则校验
        boolean success = checkInvalid(activitySkuEntity, activityEntity, activityCountEntity);
    ...
    protected abstract boolean checkInvalid(ActivitySkuEntity activitySkuEntity, ActivityEntity activityEntity, ActivityCountEntity activityCountEntity);
