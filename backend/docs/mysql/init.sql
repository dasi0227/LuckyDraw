...
CREATE DATABASE IF NOT EXISTS lucky_draw DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE lucky_draw;

DROP TABLE IF EXISTS user;
CREATE TABLE user LIKE lucky_draw_table.user;
INSERT INTO user (user_id, password)
VALUES ('wyw', MD5(123456));

DROP TABLE IF EXISTS strategy;
CREATE TABLE strategy LIKE lucky_draw_table.strategy;
...
CREATE TABLE award LIKE lucky_draw_table.award;
...
CREATE TABLE strategy_rule LIKE lucky_draw_table.strategy_rule;
...
CREATE TABLE strategy_award LIKE lucky_draw_table.strategy_award;
...
CREATE TABLE rule_tree LIKE lucky_draw_table.rule_tree;
...
CREATE TABLE rule_node LIKE lucky_draw_table.rule_node;
...
CREATE TABLE rule_edge LIKE lucky_draw_table.rule_edge;
...
CREATE TABLE activity LIKE lucky_draw_table.activity;
...
CREATE TABLE activity_sku LIKE lucky_draw_table.activity_sku;
...
CREATE TABLE trade LIKE lucky_draw_table.trade;
...
CREATE TABLE behavior LIKE lucky_draw_table.behavior;
...
分库 lucky_draw_01
============= */
DROP DATABASE IF EXISTS lucky_draw_01;
CREATE DATABASE IF NOT EXISTS lucky_draw_01 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE lucky_draw_01;
-- 任务
DROP TABLE IF EXISTS task;
CREATE TABLE task LIKE lucky_draw_table.task;
-- 账户
DROP TABLE IF EXISTS activity_account;
CREATE TABLE activity_account LIKE lucky_draw_table.activity_account;
DROP TABLE IF EXISTS activity_account_day;
CREATE TABLE activity_account_day LIKE lucky_draw_table.activity_account_day;
DROP TABLE IF EXISTS activity_account_month;
CREATE TABLE activity_account_month LIKE lucky_draw_table.activity_account_month;
-- 获奖
DROP TABLE IF EXISTS user_award_000;
CREATE TABLE IF NOT EXISTS user_award_000 LIKE lucky_draw_table.user_award;
DROP TABLE IF EXISTS user_award_001;
CREATE TABLE IF NOT EXISTS user_award_001 LIKE lucky_draw_table.user_award;
DROP TABLE IF EXISTS user_award_002;
CREATE TABLE IF NOT EXISTS user_award_002 LIKE lucky_draw_table.user_award;
DROP TABLE IF EXISTS user_award_003;
CREATE TABLE IF NOT EXISTS user_award_003 LIKE lucky_draw_table.user_award;
-- 中奖
DROP TABLE IF EXISTS activity_award_000;
CREATE TABLE IF NOT EXISTS activity_award_000 LIKE lucky_draw_table.activity_award;
DROP TABLE IF EXISTS activity_award_001;
CREATE TABLE IF NOT EXISTS activity_award_001 LIKE lucky_draw_table.activity_award;
DROP TABLE IF EXISTS activity_award_002;
CREATE TABLE IF NOT EXISTS activity_award_002 LIKE lucky_draw_table.activity_award;
DROP TABLE IF EXISTS activity_award_003;
CREATE TABLE IF NOT EXISTS activity_award_003 LIKE lucky_draw_table.activity_award;
-- 充值
DROP TABLE IF EXISTS recharge_order_000;
CREATE TABLE IF NOT EXISTS recharge_order_000 LIKE lucky_draw_table.recharge_order;
DROP TABLE IF EXISTS recharge_order_001;
CREATE TABLE IF NOT EXISTS recharge_order_001 LIKE lucky_draw_table.recharge_order;
DROP TABLE IF EXISTS recharge_order_002;
CREATE TABLE IF NOT EXISTS recharge_order_002 LIKE lucky_draw_table.recharge_order;
DROP TABLE IF EXISTS recharge_order_003;
CREATE TABLE IF NOT EXISTS recharge_order_003 LIKE lucky_draw_table.recharge_order;
-- 抽奖
DROP TABLE IF EXISTS raffle_order_000;
CREATE TABLE IF NOT EXISTS raffle_order_000 LIKE lucky_draw_table.raffle_order;
DROP TABLE IF EXISTS raffle_order_001;
CREATE TABLE IF NOT EXISTS raffle_order_001 LIKE lucky_draw_table.raffle_order;
DROP TABLE IF EXISTS raffle_order_002;
CREATE TABLE IF NOT EXISTS raffle_order_002 LIKE lucky_draw_table.raffle_order;
DROP TABLE IF EXISTS raffle_order_003;
CREATE TABLE IF NOT EXISTS raffle_order_003 LIKE lucky_draw_table.raffle_order;
-- 行为
DROP TABLE IF EXISTS reward_order_000;
CREATE TABLE IF NOT EXISTS reward_order_000 LIKE lucky_draw_table.reward_order;
DROP TABLE IF EXISTS reward_order_001;
CREATE TABLE IF NOT EXISTS reward_order_001 LIKE lucky_draw_table.reward_order;
DROP TABLE IF EXISTS reward_order_002;
CREATE TABLE IF NOT EXISTS reward_order_002 LIKE lucky_draw_table.reward_order;
DROP TABLE IF EXISTS reward_order_003;
CREATE TABLE IF NOT EXISTS reward_order_003 LIKE lucky_draw_table.reward_order;
-- 交易
DROP TABLE IF EXISTS trade_order_000;
CREATE TABLE IF NOT EXISTS trade_order_000 LIKE lucky_draw_table.trade_order;
DROP TABLE IF EXISTS trade_order_001;
CREATE TABLE IF NOT EXISTS trade_order_001 LIKE lucky_draw_table.trade_order;
DROP TABLE IF EXISTS trade_order_002;
CREATE TABLE IF NOT EXISTS trade_order_002 LIKE lucky_draw_table.trade_order;
DROP TABLE IF EXISTS trade_order_003;
CREATE TABLE IF NOT EXISTS trade_order_003 LIKE lucky_draw_table.trade_order;

/* =============
分库 lucky_draw_02
============= */
DROP DATABASE IF EXISTS lucky_draw_02;
CREATE DATABASE IF NOT EXISTS lucky_draw_02 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE lucky_draw_02;
-- 任务
DROP TABLE IF EXISTS task;
CREATE TABLE task LIKE lucky_draw_table.task;
