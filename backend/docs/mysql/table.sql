DROP DATABASE IF EXISTS lucky_draw_table;
CREATE DATABASE IF NOT EXISTS lucky_draw_table DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE lucky_draw_table;
