...
import com.dasi.trigger.http.controller.LuckyDrawController;
...
public class AopTest {
    ...
    @Test
    public void check() {
        Object bean = applicationContext.getBean("luckyDrawController");
    ...
    public void diagnose() throws Exception {
        ...
        java.lang.reflect.Method m = LuckyDrawController.class
        ...
        java.lang.reflect.Method im = ILuckyDrawService.class
                .getMethod("raffle", com.dasi.api.dto.RaffleRequest.class);
    ...
    public void dumpAdvisorsAndMatch() {
        Object controller = applicationContext.getBean("luckyDrawController");
